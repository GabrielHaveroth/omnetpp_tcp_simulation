...
* *WS_disabled_one_client*: Utilizado para analizar a questão detalhada em [GitHub Pages](https://en.wikipedia.org/wiki/TCP_window_scale_option#:~:text=The%20TCP%20window%20scale%20option,long%20fat%20networks%20(LFNs).).
